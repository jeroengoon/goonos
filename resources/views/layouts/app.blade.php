				...
				<div class="row">
					<div class="col">
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							<div class="logo"><a href="/home">Goonos.</a></div>
							<nav class="main_nav">
							@if (!(Auth::guest()))
								<ul>
										...
										<ul>
											...
											@if(count($categories) > 0)
												...
												@foreach($categories as $category)
													...
													<li style="padding-bottom:6px;"><a href="/categories">{{ $category->category_title }}</a></li>
												@endforeach
												@if(Auth::user()->admin === 1)
												</div>
												<br>
												<li><a href="/articles/create">Add Product</a></li>
									...
									<a href="/users/{{ Auth::user()->id }}">Profile</a>
										<ul>
											...
											<li><a href="/users/{{ Auth::user()->id }}">Show/Edit Profile</a></li>
											<li><a href="/users/{{ Auth::user()->id }}">My Orders</a></li>
									...
									<!-- <li><a href="/contact">Shoppingcart</a> -->
...
-->
							...
							@if (Auth::guest())
								...
								<li><a href="{{ route('login') }}">Login</a></li></a></li></li>
								<li><a href="{{ route('register') }}">Register</a></li>
								<li><a href="/contact">Contact</a></li>
							</a></li></ul></li></nav class="main_nav">
							@else
							...
							<nav class="main_nav"><ul><li></li></ul></li></nav class="main_nav">
			...
			<div class="row">
				<div class="col">
					<div class="footer_content d-flex flex-lg-row flex-column align-items-center justify-content-lg-start justify-content-center">
						<!-- <div class="footer_logo"><a href="home">Sublime.</a></div> -->
